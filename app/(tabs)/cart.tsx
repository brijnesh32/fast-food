...
const Cart = () => {
  ...
  const [deliveryOption, setDeliveryOption] = useState<"delivery" | "dine-in">(
    "delivery",
  );
            ...
            <View className="gap-5">
              ...
              <View className="mt-6">
                ...
                <View className="flex-row bg-gray-100 p-1 rounded-2xl">
                  ...
                  >
                    <Text
                      className={`text-center font-semibold ${deliveryOption === "delivery" ? "text-black" : "text-gray-500"}`}
                    >
                      Delivery
                    </Text>
                  </TouchableOpacity>
                  ...
                  >
                    <Text
                      className={`text-center font-semibold ${deliveryOption === "dine-in" ? "text-black" : "text-gray-500"}`}
                    >
                      Dine-in
                    </Text>
                  </TouchableOpacity>
